/*************************************************************************
	> File Name: /home/jensen/ysyx-workbench/npc/csrc/monitor/sdb/expr.c
	> Author: Jensen
	> Mail: 1624839259@qq.com 
	> Created Time: 2025年02月20日 星期四 11时32分06秒
 ************************************************************************/
...
static bool make_token(char *e) {
  ...
  while (e[position] != '\0') {
    ...
    for (i = 0; i < NR_REGEX; i ++) {
      if (regexec(&re[i], e + position, 1, &pmatch, 0) == 0 && pmatch.rm_so == 0) { //segment error
