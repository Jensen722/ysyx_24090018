...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div    , R, R(rd) = (int32_t)src2 ? -1 : (((int32_t)src2 == -1 && (int32_t)src1 == -2147483648) ? (int32_t)src1 : (int32_t)src1 / (int32_t)src2 )); //有符号数除法需要判断除0行为和除法溢出
